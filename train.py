...
from human_data import SMPL_DATA
from animal_data import SMAL_DATA
...
for epoch in iter_counter.training_epochs(): 
    ...
    for i, data_i in enumerate(dataloader, start=iter_counter.epoch_iter):
        ...
        # get data
        identity_points, pose_points, gt_points, new_face1, new_face2 = data_i

        # training
        trainer.train_model(identity_points, pose_points, gt_points, new_face1)
